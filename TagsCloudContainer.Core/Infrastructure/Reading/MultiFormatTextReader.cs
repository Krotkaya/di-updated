...
public class MultiFormatTextReader(IEnumerable<ITextReader> readers) : ITextReader
{
    private readonly IReadOnlyCollection<ITextReader> _readers = readers.ToArray();
